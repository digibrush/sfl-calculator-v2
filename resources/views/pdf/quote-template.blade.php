                ...
                <table width="100%" style="color: #153147" border="0">
                    ...
                    <tr style="height:20px;">
                        <table width="100%">
                            <tbody>
                            <td width="5%">&nbsp;</td>
                            <td width="50%" style="padding-bottom: 10px;color: black;">Solution Name (Total)</td>
                            <td width="20%" style="text-align: center; color: black;">
                                10
                            </td>
                            <td width="20%" style="text-align: center; color: black;">
                                1000.00
                                ...
                                <tr>
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td width="20%" style="text-align: center;padding-top: 10px;padding-bottom: 10px; color: #0c283c">100</td>
...
<ul>
    <li style="padding-left: 10px; margin-top: 20px; margin-bottom:20px; font-weight: 400; font-size: 13px">Term Topic 1
        <ul>
            <li style="height: 20px; font-size: 13px; font-weight: normal; margin-top: 8px; ">Term Condition 1</li>
            <li style="height: 20px; font-size: 13px; font-weight: normal; margin-top: 8px; ">Term Condition 2</li>
        </ul>
    </li>
    <li style="padding-left: 10px; margin-top: 20px; margin-bottom:20px; font-weight: 400; font-size: 13px">Term Topic 2
        <ul>
            <li style="height: 20px; font-size: 13px; font-weight: normal; margin-top: 8px; ">Term Condition 3</li>
            <li style="height: 20px; font-size: 13px; font-weight: normal; margin-top: 8px; ">Term Condition 4</li>
        </ul>
    </li>
</ul>
